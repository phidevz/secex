/*
  ---------------------------------------------------------------------
  Taken from: https://github.com/Rob--W/open-in-browser
  Licened under the MPL v2.0
  ---------------------------------------------------------------------
  This Source Code Form is subject to the terms of the Mozilla Public
  License, v. 2.0. If a copy of the MPL was not distributed with this
  file, You can obtain one at https://mozilla.org/MPL/2.0/.
  
  Original idea by Sylvain Pasche <sylvain.pasche@gmail.com>.
  Current version by Rob Wu <rob@robwu.nl>.
  ---------------------------------------------------------------------
*/
 ...
 * @return {string|null} Filename, if found in the Content-Disposition header.
 */
export function getFilenameFromContentDispositionHeader(contentDisposition: string | null): string | null {
    ...
    function toParamRegExp(attributePattern: string, flags: string | undefined) {
        return new RegExp(
    ...
    function rfc2231getparam(contentDisposition: string) {
        ...
        return value.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g,
            function (_, charset, encoding, text) {
                if (encoding === 'q' || encoding === 'Q') {
                    ...
                    text = text.replace(/=([0-9a-fA-F]{2})/g, (_: any, hex: string) => String.fromCharCode(parseInt(hex, 16)));
